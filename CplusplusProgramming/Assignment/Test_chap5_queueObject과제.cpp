...
public:
    void Show();
    void Add(Person&); //don't use pointer as a parameter
    Person& Delete();
};
...
int main() {
    ...
    while (1)
    {
        ...
        case 2://AddOne
            ...
            cin >> sno >> sname >> year;
            Person *px = new Person(sno, sname, year); //copy constructor
            //Person px = Person p4(sno, sname, year); //check
            q1.Add(px);
            break;
